...
module DescriptionExtensionsHelper
  attr_accessor :full_name
end

describe "An instance extended with DescriptionExtensions" do
  extend DescriptionExtensions
  extend DescriptionExtensionsHelper
  ...
  it "should return the proper ri path" do
    self.class.stubs(:to_s).returns('RDoc::RI::ClassDescription')
    ri_type.should == 'Class'
    
    self.class.stubs(:to_s).returns('RDoc::RI::MethodDescription')
